...
final Map<String, WidgetBuilder> routes = {
  ...
  SmartphoneScreen.routeName: (context) => const SmartphoneScreen(),
  HeadphoneScreen.routeName: (context) => const HeadphoneScreen(),
  KeyboardScreen.routeName: (context) => const KeyboardScreen(),
  MouseScreen.routeName: (context) => const MouseScreen(),
